...
CREATE TABLE IF NOT EXISTS work_shifts (id INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY, tenant_id INTEGER NOT NULL, branch_id INTEGER NOT NULL, opened_by_user_id INTEGER NOT NULL, closed_by_user_id INTEGER, opened_at TEXT NOT NULL, closed_at TEXT, opening_cash DOUBLE PRECISION NOT NULL DEFAULT 0, counted_cash DOUBLE PRECISION, expected_cash DOUBLE PRECISION, difference DOUBLE PRECISION, status TEXT NOT NULL DEFAULT 'open', notes TEXT NOT NULL DEFAULT '', summary_json TEXT);
...
CREATE TABLE IF NOT EXISTS inventory_counts (id INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY, tenant_id INTEGER NOT NULL, branch_id INTEGER NOT NULL, ingredient_id INTEGER NOT NULL, system_qty DOUBLE PRECISION NOT NULL, counted_qty DOUBLE PRECISION NOT NULL, difference DOUBLE PRECISION NOT NULL, note TEXT NOT NULL DEFAULT '', counted_by_user_id INTEGER, counted_at TEXT NOT NULL);
...
CREATE TABLE IF NOT EXISTS receipt_settings (id INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY, tenant_id INTEGER NOT NULL, branch_id INTEGER NOT NULL, settings_json TEXT NOT NULL DEFAULT '{}', updated_by_user_id INTEGER, updated_at TEXT NOT NULL, UNIQUE(tenant_id,branch_id));
