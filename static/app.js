  ...
  try{
    ...
    if(sh){
      ...
      status.innerHTML=`
        ...
        ${blind?'<div class="shift-state-card shift-kpi"><small>เงินสด</small><b>ซ่อนจนกว่าจะปิดกะ</b><span class="shift-sub">Blind Cash Count</span></div>':`<div class="shift-state-card shift-kpi"><small>เงินสด</small><b>${fmtMoney(pb.cash||0)}</b><span class="shift-sub">รับเงินจริงในกะนี้</span></div>`}
