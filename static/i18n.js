...
const I18N = {
  ...
  err_network_check: { th: 'การเชื่อมต่อขัดข้อง กรุณาตรวจสอบอินเทอร์เน็ตแล้วลองอีกครั้ง', lo: 'ການເຊື່ອມຕໍ່ຂັດຂ້ອງ ກະລຸນາກວດອິນເຕີເນັດແລ້ວລອງໃໝ່', zh: '连接异常，请检查网络后重试', en: 'Connection problem. Check your internet connection and try again.' },
  err_server_unreachable: { th: 'ไม่สามารถเชื่อมต่อเซิร์ฟเวอร์ได้', lo: 'ບໍ່ສາມາດເຊື່ອມຕໍ່ເຊີບເວີໄດ້', zh: '无法连接服务器', en: 'Could not reach the server.' },
  err_save_server: { th: 'ระบบบันทึกข้อมูลขัดข้อง กรุณาลองอีกครั้ง', lo: 'ລະບົບບັນທຶກຂໍ້ມູນຂັດຂ້ອງ ກະລຸນາລອງໃໝ່', zh: '保存数据时发生错误，请重试', en: 'The server could not save the data. Please try again.' },
  offline_queue_count: { th: '{n} รายการ', lo: '{n} ລາຍການ', zh: '{n} 项', en: '{n} items' },
  offline_table_prefix: { th: 'โต๊ะ', lo: 'ໂຕະ', zh: '桌号', en: 'Table' },
  offline_conflict: { th: 'ต้องตรวจสอบ', lo: 'ຕ້ອງກວດສອບ', zh: '需要检查', en: 'Needs review' },
  offline_pending: { th: 'รอส่ง', lo: 'ລໍຖ້າສົ່ງ', zh: '等待同步', en: 'Waiting to sync' },
  offline_retry: { th: 'ลองใหม่', lo: 'ລອງໃໝ່', zh: '重试', en: 'Retry' },
  offline_remove: { th: 'ลบคิว', lo: 'ລຶບຄິວ', zh: '移除队列', en: 'Remove from queue' },
  ...
  nav_dashboard: { th: 'หน้าหลัก', lo: 'ໜ້າຫຼັກ', zh: '首页', en: 'Dashboard' },
  nav_take_order: { th: 'รับออเดอร์', lo: 'ຮັບອໍເດີ', zh: '点单', en: 'Take order' },
  nav_tables: { th: 'โต๊ะ', lo: 'ໂຕະ', zh: '桌台', en: 'Tables' },
  nav_kitchen: { th: 'ครัว', lo: 'ຄົວ', zh: '厨房', en: 'Kitchen' },
  nav_billing: { th: 'ชำระเงิน', lo: 'ຊຳລະເງິນ', zh: '结账', en: 'Payment' },
  nav_shift: { th: 'กะ & เงินสด', lo: 'ກະ & ເງິນສົດ', zh: '班次与现金', en: 'Shift & cash' },
  nav_customers: { th: 'ลูกค้า', lo: 'ລູກຄ້າ', zh: '顾客', en: 'Customers' },
  nav_staff: { th: 'พนักงาน', lo: 'ພະນັກງານ', zh: '员工', en: 'Staff' },
  nav_settings: { th: 'ตั้งค่า', lo: 'ຕັ້ງຄ່າ', zh: '设置', en: 'Settings' },
  btn_take_order_short: { th: 'กลับบ้าน / เดลิเวอรี่', lo: 'ກັບບ້ານ / ເດລິເວີຣີ', zh: '外带 / 外送', en: 'Takeaway / delivery' },
  ...
  reports_title: { th: 'สรุปยอดขาย & รายรับ-รายจ่าย', lo: 'ສະຫຼຸບຍອດຂາຍ & ລາຍຮັບ-ລາຍຈ່າຍ', zh: '销售总结与收支', en: 'Sales summary & income/expense' },
  preset_today: { th: 'วันนี้', lo: 'ມື້ນີ້', zh: '今天', en: 'Today' },
  preset_yesterday: { th: 'เมื่อวาน', lo: 'ມື້ວານນີ້', zh: '昨天', en: 'Yesterday' },
  preset_last_7_days: { th: '7 วันที่ผ่านมา', lo: '7 ມື້ຜ່ານມາ', zh: '过去7天', en: 'Last 7 days' },
  preset_this_month: { th: 'เดือนนี้', lo: 'ເດືອນນີ້', zh: '本月', en: 'This month' },
  preset_this_year: { th: 'ปีนี้', lo: 'ປີນີ້', zh: '今年', en: 'This year' },
  label_from_date: { th: 'จากวันที่', lo: 'ຈາກວັນທີ', zh: '开始日期', en: 'From date' },
  label_to_date: { th: 'ถึงวันที่', lo: 'ຫາວັນທີ', zh: '结束日期', en: 'To date' },
  btn_apply_filter: { th: 'ดูรายงาน', lo: 'ເບິ່ງລາຍງານ', zh: '查看报表', en: 'View report' },
  label_total_sales: { th: 'ยอดขายรวม', lo: 'ຍອດຂາຍລວມ', zh: '总销售额', en: 'Total sales' },
  ...
  placeholder_expense_category: { th: 'เช่น ค่าวัตถุดิบ', lo: 'ເຊັ່ນ ຄ່າວັດຖຸດິບ', zh: '例如：食材费', en: 'e.g. Ingredients' },
  err_expense_category_required: { th: 'กรุณาเลือกหรือกรอกหมวดรายจ่าย', lo: 'ກະລຸນາເລືອກ ຫຼື ປ້ອນໝວດລາຍຈ່າຍ', zh: '请选择或填写支出类别', en: 'Please choose or enter a category' },
  err_expense_amount_invalid: { th: 'จำนวนเงินไม่ถูกต้อง', lo: 'ຈຳນວນເງິນບໍ່ຖືກຕ້ອງ', zh: '金额无效', en: 'Invalid amount' },
  confirm_delete_expense: { th: 'ลบรายการรายจ่ายนี้?', lo: 'ລຶບລາຍການລາຍຈ່າຍນີ້?', zh: '确定删除此支出记录？', en: 'Delete this expense?' },
  label_cost_price: { th: 'ต้นทุน', lo: 'ຕົ້ນທຶນ', zh: '成本价', en: 'Cost price' },
  label_track_stock: { th: 'นับสต็อกเมนูนี้', lo: 'ນັບສະຕັອກເມນູນີ້', zh: '追踪此商品库存', en: 'Track stock for this item' },
  label_stock_qty: { th: 'จำนวนคงเหลือ', lo: 'ຈຳນວນທີ່ເຫຼືອ', zh: '库存数量', en: 'Stock on hand' },
